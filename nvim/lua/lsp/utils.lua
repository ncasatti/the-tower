...
M.on_attach = function(client, bufnr)
  ...
  nmap('<leader>lwa', vim.lsp.buf.add_workspace_folder, '󰅱 [W]orkspace [A]dd Folder')
  nmap('<leader>lwr', vim.lsp.buf.remove_workspace_folder, '󰅱 [W]orkspace [R]emove Folder')
